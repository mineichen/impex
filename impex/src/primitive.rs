...
///
#[derive(serde::Deserialize, PartialEq, Eq, serde::Serialize, std::fmt::Debug, Default)]
pub struct PrimitiveWrapper<T>(pub T);
impl<T: serde::de::DeserializeOwned + PartialEq + Eq + serde::Serialize + Debug + Default>
