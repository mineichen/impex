...
#[serde(default)]
pub struct ImpexKeyStructConfig<TW: ::impex::WrapperSettings> {
...
pub enum ImpexEnumConfig<TW: ::impex::WrapperSettings>
// where
...
pub struct ImpexTupleStructConfig<TW: ::impex::WrapperSettings>(
